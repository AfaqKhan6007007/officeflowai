...
export default function SalesChoice() {
    // Observe the section
  ...
  const moduleData = [
    {
        src: "/efficiency.png",    
        title: "Efficiency",
        desc: "Automates lead capture, follow-ups, and reporting to reduce manual effort and sales cycle time.",
    },
    {
        src: "/accuracy.png",
        title: "Accuracy",
        desc: "AI-driven data extraction, duplicate detection, and real-time syncing ensure clean and reliable sales data.",
    },
    {
        src: "/organization.png",
        title: "Organization",
        desc: "Centralized leads, communications, and performance tracking keep teams aligned and focused.",
    },
    {
        src: "/visibility.png",
        title: "Visibility",
        desc: "Complete visibility into pipeline health, employee performance, and conversion trends across regions.",
    },
];
    return (
        <section
    ...
    >
            <div className='relative flex flex-col gap-4 mb-22 items-center justify-center z-30 mt-10 text-center'>
                ...
                Why Teams Choose Our Sales & Marketing Module
                </h1>
            </div>
