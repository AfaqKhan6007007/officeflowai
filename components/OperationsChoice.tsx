  ...
  const moduleData = [
    {
        src: "/efficiency.png",    
        title: "Efficiency",
        desc: "Automate inventory tracking, project management, asset handling, training workflows, and shift planning to reduce manual work.",
    },
    {
        src: "/accuracy.png",
        title: "Accuracy",
        desc: "Use AI-powered extraction, analytics, and validation to minimize errors across operations and scheduling.",
    },
    {
        src: "/organization.png",
        title: "Organization",
        desc: "Centralize all operational data, inventory, projects, assets, training, and shifts for structured visibility.",
    },
    {
        src: "/visibility.png",
        title: "Visibility",
        desc: "Gain real-time insights into stock levels, project progress, asset usage, employee readiness, and schedule compliance.",
    },
];
    return (
        <section
    ...
    >
            <div className='relative flex flex-col gap-4 mb-22 items-center justify-center z-30 mt-10 text-center'>
                ...
                Why Teams Choose Our Operations Module
                </h1>
            </div>
