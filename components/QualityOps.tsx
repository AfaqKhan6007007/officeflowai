export default function QualityOps() {
    return (
        <div className="mx-auto flex flex-col w-full gap-10 bg-white pt-10 pb-10 items-center border-t-2 border-gray-300">
            ...
            Move to Predictive Quality Intelligence
            </h1>
            <p className="text-center text-gray-700 max-w-2xl mx-auto">
             Manage risks, ensure compliance, and drive continuous improvement with one intelligent quality platform.
            </p>
            <div className="mt-10 flex gap-4">
                ...
                >
                    Get Started with Quality Management Module
                </button>
