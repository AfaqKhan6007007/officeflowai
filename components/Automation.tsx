...
export default function Automation() {
  const [active, setActive] = useState("Attendance Management");
  ...
  const screens: Record<string, string> = {
    "Attendance Management": "/Screen1.png",
    "Leave Management": "/Screen2.png",
    "Employee Directory": "/Screen3.png",
    "Payroll": "/Screen4.png",
    "Performance Tracking": "/Screen5.png",
  };
