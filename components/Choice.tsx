  ...
  const moduleData = [
    {
        src: "/efficiency.png",    
        title: "Efficiency",
        desc: "Reduce manual HR work and repetitive tasks with intelligent automation workflows.",
    },
    {
        src: "/accuracy.png",
        title: "Accuracy",
        desc: "Minimize payroll errors and delays with real time validation and compliance check.",
    },
    {
        src: "/organization.png",
        title: "Organization",
        desc: "Maintain clear and organized employee records in a secure centralized digital vault.",
    },
    {
        src: "/visibility.png",
        title: "Visibility",
        desc: "Improve visibility across HR operations with powerful analytics and custom dashboards.",
    },
];
    return (
        <section
    ...
    >
            <div className='relative flex flex-col gap-4 mb-22 items-center justify-center z-30 mt-10 text-center'>
                ...
                Why Teams Choose Our HR Module
                </h1>
            </div>
