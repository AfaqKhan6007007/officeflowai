    ...
    return (
        <div className="mx-auto flex flex-col w-full gap-10 bg-white pt-10 pb-10 items-center border-t-2 border-gray-300">
            <h1 className="text-4xl font-bold text-center text-[#005143]">
              Start Smarter Operations Today
            </h1>
            <p className="text-center text-gray-700 max-w-2xl mx-auto">
              Experience OfficeFlow AI and streamline every aspect of your business HR, Finance, Procurement, Sales, Quality, and Operations all in one connected platform.
            </p>
