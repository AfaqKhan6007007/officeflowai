export default function OperationsOps() {
    return (
        <div className="mx-auto flex flex-col w-full gap-10 bg-white pt-10 pb-10 items-center border-t-2 border-gray-300">
            ...
            Streamline Your Operations with AI-Powered Control
            </h1>
            <p className="text-center text-gray-700 max-w-2xl mx-auto">
             Manage resources, projects, assets, and employee workflows in one intelligent platform.
            </p>
            <div className="mt-10 flex gap-4">
                ...
                >
                    Get Started with Operations Module
                </button>
