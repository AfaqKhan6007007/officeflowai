...
export default function HeroQuality() {
  return (
    <div className="flex flex-col lg:flex-row gap-8 lg:gap-10 px-6 lg:px-0 mt-12 lg:mt-20 mb-12 lg:mb-20 relative">
      ...
      <div className="relative max-w-full lg:max-w-2xl mx-auto lg:mx-0 text-center lg:text-left pl-0 sm:pl-20">
        ...
        Detect risks early, ensure compliance, manage supplier quality, and drive continuous improvement with AI-powered quality workflows.
        </p>
      ...
      <div className="relative w-full flex justify-center lg:justify-end mt-8 lg:mt-0 lg:mr-20">
        <FloatingSvg
          ...
          size={160}
          delay={0}
          className="top-10 lg:top-70 left-0 lg:left-50 z-10"
        />
        ...
        <FloatingSvg
          src="/inspection.png"
          size={180}
          className="top-46 lg:top-82 right-10 lg:right-10"
          delay={3}
        />
        ...
        <FloatingSvg
          src="/active.png"
          size={160}
          className="top-0 lg:top-18 right-0 lg:right-110"
          delay={1.5}
        />
      </div>
    </div>
